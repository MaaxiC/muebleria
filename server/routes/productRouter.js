...
const { getProducts, getProductById, createProduct, updateProduct, deleteProduct, updateStock, getRecProducts, getFavProducts, getCatProducts, getCountCatProducts, getCountProducts } = ProductController;
...
productRouter.get("/count", getCountProducts);
